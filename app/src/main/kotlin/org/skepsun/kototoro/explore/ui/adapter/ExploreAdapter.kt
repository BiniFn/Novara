...
class ExploreAdapter(
    ...
    private val sourceClickListener: OnListItemClickListener<MangaSourceItem>,
    private val recommendationClickListener: OnListItemClickListener<Manga>,
    ...
    override fun getItemViewType(position: Int): Int {
        ...
        return when (item) {
            ...
            is MangaSourceItem -> if (item.isGrid) {
