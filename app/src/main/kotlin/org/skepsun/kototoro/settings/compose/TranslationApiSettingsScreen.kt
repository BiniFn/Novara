    ...
    Surface(
        ...
        Column(
            ...
            SettingsChoicePreference(
                ...
                value = settings.observeAsState(AppSettings.KEY_READER_TRANSLATION_API_PROVIDER_PRESET) { prefs.getString(AppSettings.KEY_READER_TRANSLATION_API_PROVIDER_PRESET, "CUSTOM") ?: "CUSTOM" }.value,
            ...
            SettingsTextInputPreference(
                ...
                value = settings.observeAsState(AppSettings.KEY_READER_TRANSLATION_API_ENDPOINT) { prefs.getString(AppSettings.KEY_READER_TRANSLATION_API_ENDPOINT, "") ?: "" }.value,
            ...
            SettingsTextInputPreference(
                ...
                value = settings.observeAsState(AppSettings.KEY_READER_TRANSLATION_API_KEY) { prefs.getString(AppSettings.KEY_READER_TRANSLATION_API_KEY, "") ?: "" }.value,
                isPassword = true,
            ...
            SettingsTextInputPreference(
                ...
                value = settings.observeAsState(AppSettings.KEY_READER_TRANSLATION_API_MODEL) { prefs.getString(AppSettings.KEY_READER_TRANSLATION_API_MODEL, "gpt-4o-mini") ?: "gpt-4o-mini" }.value,
            ...
            SettingsTextInputPreference(
                ...
                value = settings.observeAsState(AppSettings.KEY_READER_TRANSLATION_API_CUSTOM_HEADERS) { prefs.getString(AppSettings.KEY_READER_TRANSLATION_API_CUSTOM_HEADERS, "") ?: "" }.value,
